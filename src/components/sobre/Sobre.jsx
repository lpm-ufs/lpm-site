            ...
            <div className="home__wrapper">
                <div className="home__container container">
                    ...
                    <p className="home__text">
                        O Laboratório de Projetos Mecânicos do Departamento de Engenharia Mecânica da Universidade Federal de Sergipe (UFS), parte do Centro Tecnológico em Engenharia Avançada (CTEA), se dedica ao ensino, pesquisa e extensão em várias áreas da engenharia. Atendendo diariamente alunos, o laboratório desenvolve pesquisas em aeronaves remotamente pilotadas, enxames de drones, metamateriais, visão computacional, Structural Health Monitoring, metrologia, inteligência artificial, fotogrametria e energias renováveis. Também realiza projetos de extensão, como oficinas de minifoguetes, astronomia, e equipes de foguetes e cubesats (Zenith).
                    </p>
